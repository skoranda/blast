...
import os
from astro_dash.infrastructure.ml.templates.dash_template_handler import DASHSpectrumTemplate
from astro_dash.infrastructure.ml.templates.transformer_template_handler import TransformerSpectrumTemplate
from astro_dash.infrastructure.ml.templates.template_interface import SpectrumTemplateInterface
from astro_dash.core.exceptions import FileNotFoundException, ModelConfigurationException
...
def create_spectrum_template_handler(model_type: str, template_path: Optional[str] = None) -> SpectrumTemplateInterface:
    ...
    if model_type == 'dash':
        if not template_path:
            ...
            from astro_dash.config.settings import get_settings
