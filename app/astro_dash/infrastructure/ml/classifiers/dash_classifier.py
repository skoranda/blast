...
from astro_dash.infrastructure.ml.classifiers.architectures import AstroDashPyTorchNet
from astro_dash.config.settings import get_settings, Settings
from astro_dash.infrastructure.ml.dash_utils import combined_prob
    ...
    def classify_sync(self, spectrum: Any) -> dict:
        ...
        if calculate_rlap:
            try:
                ...
                from astro_dash.infrastructure.ml.rlap_calculator import prepare_log_wavelength_and_templates, get_templates_for_type_age, normalize_age_bin, get_nonzero_minmax, calculate_rlap_with_redshift
